                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <label for="change-status-order">Change Status</label>
                                            <select class="form-control" id="change-status-order" id_order="<?= $dataPayment['id'] ?>">
                                                <option value="0" <?= $dataPayment['status'] == '0' ? 'selected' : ''?>>Pending</option>
                                                <option value="1" <?= $dataPayment['status'] == '1' ? 'selected' : ''?>>Processing</option>
                                                <option value="2" <?= $dataPayment['status'] == '2' ? 'selected' : ''?>>Completed</option>
                                                <option value="3" <?= $dataPayment['status'] == '3' ? 'selected' : ''?>>Cancel</option>
                                            </select>
                                        </div>
                                    </td>
                                    <td></td>
