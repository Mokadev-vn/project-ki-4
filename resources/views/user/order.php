                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($payment['status'] > 0) : ?>
                                            <a href="#" class="table-action" data-toggle="tooltip" data-original-title="Can not Cancel">
                                                <i class="fas fa-minus-circle"></i>
                                            </a>
                                        <?php else : ?>
                                            <a href="#" class="table-action cancel-order" id_order="<?= $payment['id'] ?>" data-toggle="tooltip" data-original-title="Cancel">
                                                <i class="fas fa-minus-circle"></i>
                                            </a>
                                        <?php endif; ?>
                                    </td>
