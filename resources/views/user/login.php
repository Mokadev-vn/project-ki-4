<?php layout('user.layouts.header', ['title' => 'Login Account']); ?>
<!-- Main content -->
  ...
  <div class="container mt--8 pb-5">
    <div class="row justify-content-center">
      <div class="col-lg-5 col-md-7">
            ...
            <form role="form">
              ...
              <div class="form-group mb-3">
                <div class="input-group input-group-merge input-group-alternative">
                  ...
                  <input class="form-control" id="username" placeholder="Username" type="text" require>
                </div>
        ...
        <div class="row mt-3">
          <div class="col-6">
            <a href="<?= APP_CONFIG['url'] ?>reset-password" class="text-light"><small>Forgot password?</small></a>
          </div>
